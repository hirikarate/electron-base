 ...
 */
gulp.task('set-build-mode', development.task);     // Build as Development mode (with source maps)
//gulp.task('set-build-mode', production.task);    // Build as Production mode (minification, no source maps)
